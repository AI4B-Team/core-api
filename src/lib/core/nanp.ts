/**
 * NANP area code -> US state/DC. Used to resolve the *called party's*
 * jurisdiction for recording-consent evaluation. An unknown or non-US number
 * resolves to null, which always forces an announcement.
 */
const AREA_CODES: Record<string, string[]> = {
  ...
  DC: ["202"],
  FL: [
    "239", "305", "321", "324", "352", "386", "407", "448", "561", "656", "689", "727", "754",
  ...
  NM: ["505", "575"],
  NY: [
    "212", "315", "329", "332", "347", "363", "516", "518", "585", "607", "624", "631", "646",
  ...
  TX: [
    ...
    "713", "726", "737", "806", "817", "830", "832", "903", "915", "936", "940", "945", "956",
    "972", "979",
  ],
  UT: ["385", "435", "801"],
  VT: ["802"],
...
const BY_CODE: Record<string, string> = (() => {
  ...
  for (const [state, codes] of Object.entries(AREA_CODES)) for (const c of codes) map[c] = state;
  return map;
})();

/** Returns a two-letter state code, or null when the jurisdiction is unknown. */
export function stateFromE164(e164: string | null | undefined): string | null {
  if (!e164) return null;
  const digits = e164.replace(/\D/g, "");
  const national = digits.length === 11 && digits.startsWith("1") ? digits.slice(1) : digits;
  if (national.length !== 10) return null;
  return BY_CODE[national.slice(0, 3)] ?? null;
}
